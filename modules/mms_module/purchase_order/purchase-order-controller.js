...
const mdl = require('./purchase-order-model');
const m_line = require('./purchase-order-line-model');
const m_status = require('./purchase-order-status-model');
const m_purchase_request = require('../purchase_request/purchase-request-model');
const m_purchase_request_line = require('../purchase_request/purchase-request-line-model');
const m_purchase_request_status = require('../purchase_request/purchase-request-status-model');
class MyController extends BaseController {
	...
	async GetTransactionNumber() {
		try {
			...
			const result = global.GenerateTransNo('PO', item.record_count);
			return result;
		} catch (err) {
			console.log(err);
			return '';
