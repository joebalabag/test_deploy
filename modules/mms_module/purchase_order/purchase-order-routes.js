...
const ctrl = require('./purchase-order-controller');
const myroute = '/mms';
const subroute = '/purchase-order';
//router.use(myroute, authenticate);

router.get(myroute + subroute + '/dashboard-pr', ctrl.dashboard_pr.bind(ctrl));
router.get(myroute + subroute + '/dashboard-po', ctrl.dashboard_po.bind(ctrl));
